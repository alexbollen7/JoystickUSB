...
;USB_DSC.c,183 :: 		void USB_Init_Desc(){
;USB_DSC.c,184 :: 		USB_config_dsc_ptr[0] = &configDescriptor1;
...
;USB_DSC.c,185 :: 		USB_string_dsc_ptr[0] = (const char*)&strd1;
	MOVLW       _strd1+0
...
;USB_DSC.c,186 :: 		USB_string_dsc_ptr[1] = (const char*)&strd2;
	MOVLW       _strd2+0
...
;USB_DSC.c,187 :: 		USB_string_dsc_ptr[2] = (const char*)&strd3;
	MOVLW       _strd3+0
