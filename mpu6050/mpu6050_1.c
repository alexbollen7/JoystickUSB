//MPU6050 Pic Microcontroller Code (MikroC)
//This example code of MPU6050 for PIC18F46K22 microcontroller is written in C language with MikroC for pic compiler.
...
I2C1_Init(400000);
 ...
 I2C1_Wr( 0 ); //gyro_config, +-250 °/s
 I2C1_Wr( 0 ); //accel_config +-2g
 I2C1_Stop();
}
...
void main()
{
     osccon=0xfc;           //externo cristal 4 Mhz
     PORTB = 0;
     trisb=0xff;
     ...
     HID_Enable(readbuff,writebuff);
      ...
      while(1)
      {
       ...
       x_axis= Sensor.Accel.X>>7;      //Read only the upper 8 bits of the ADC
